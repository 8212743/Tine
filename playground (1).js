...
mintNFT ("Tine", "Blue", "Tank Top", "Gold Chains");
mintNFT ("Jeanelle", "Black", "Shirt", "Wrist Watch");
mintNFT ("Jarod", "Gray", "Suit", "Bracelet");
mintNFT ("Nica", "White", "Sweatshirt", "Ring");
mintNFT ("Nolie", "Red", "Polo", "Necklace");
listTKNS ();
getTotalSupply
